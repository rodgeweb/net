...
<div class="container">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="middle_name" value="<?= $user->middle_name ?>" placeholder="Middle Name" />
    </div>
    <div class="form-group">
        <label>Email</label>
    ...
    <div class="form-group">
        <input class="btn btn-primary" type="submit" name="update-profile" value="Update Profile" />
    </div>
    <?= form_close(); ?>
</div>